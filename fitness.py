...
# Jaccard similarity 
def jaccard_similarity_fitness(individual, word):
...
def nlcs_fitness(individual, word):
...
def cosine_similarity_fitness(individual, word):
...
def ngram_overlap_fitness(individual, word, n=2):
...
def manhattan_distance_fitness(individual, word):
    m = len(individual)
    n = len(word)    
...
def pearson_correlation_fitness(individual, word):
    individual_len = len(individual)
    word_len = len(word)            
